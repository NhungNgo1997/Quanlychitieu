...
public class ThongKeNgay_Fagment extends Fragment {
    public static final String URL_TONG="http://quanlychitieuntknhung.000webhostapp.com/qlchitieu/";
    String url=URL_TONG+"laykhoanchingay.php";
    String url1=URL_TONG+"laykhoanthungay.php";
    String url2=URL_TONG+"tongthungay.php";
    String url3=URL_TONG+"tongchingay.php";

    ListView lvtkchi,lvktthu;
    TextView tongthu, tongchi;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view= inflater.inflate(R.layout.thongkengay_fagment, container,false);
