...
public class ThongKeNam_Fagment extends Fragment {
    public static final String URL_TONG = "http://quanlychitieuntknhung.000webhostapp.com/qlchitieu/";
    String url= URL_TONG+"laykhoanchinam.php";
    String url1=URL_TONG+ "laykhoanthunam.php";
    String url2=URL_TONG+"tongthunam.php";
    String url3=URL_TONG+"tongchinam.php";
    String url4=URL_TONG+"sodunam.php";
    TextView tongthu, tongchi,tvsodu;
    ListView lvtkchi,lvktthu;

   ArrayList<String> tongkhoanthu;
    String username="";
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view= inflater.inflate(R.layout.thongkenam_fagment, container,false);
